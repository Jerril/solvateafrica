...
@section('content')
   ...
   <div class="page-header d-md-flex justify-content-between">
        <div>
            ...
            <p class="text-muted">This page shows an overview.</p>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h6 class="card-title mb-2">Users Report</h6>
                        <!-- <div class="dropdown">
                    ...
                    <div>
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <h3 class="text-success mb-0">{{$users_last_month}}</h3>
                            </div>
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <div>
                                    <h5>Stats</h5>
                                ...
                                <div>
                                    <h3 class="text-danger mb-0">{{$users_last_week}}</h3>
                                </div>
                            </div>
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <div>
                                ...
                                <div>
                                    <h3 class="text-info mb-0"> {{$users_month}}</h3>
                                </div>
                            </div>
                            <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <div>
                                ...
                                <div>
                                    <h3 class="text-primary mb-0">{{$users_last_year}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3">{{$users}}</div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3">{{$gigs}}</div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3"> {{$jobs}}</div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3"> {{$projects}}</div>
                            </div>
